...
const PlayBar = () => {
  ...
  const setStartTime = event => updateStartTime(Number.parseFloat(event.target.value))

  const setEndTime = event => updateEndTime(Number.parseFloat(event.target.value))
